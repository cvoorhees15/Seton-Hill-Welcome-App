    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                ...
                Text("This is the main dining hall on campus. You will find it on the first floor of Lowe Hall which is connected to Maura Hall, Canevin Hall and the Administration Building. The two main entances are across the street from Lynch Hall in the quad between Maura Hall and Canevin Hall. Here you will find the most options when looking for something to eat. You have the ability to sit and eat in Lowe's dining area, the Greensburg Room which is directly adjacent to the dining hall, or somewhere else on campus by requesting a to-go box.")
                    .navigationTitle("Lowe Dining Hall")
                    .padding(20)
                    .multilineTextAlignment(.center)
                    .background(Color("App_Red").cornerRadius(30).padding(5))
